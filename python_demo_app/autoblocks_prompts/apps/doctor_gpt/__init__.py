...
) -> prompts._ClinicalAnswererV1PromptManager:
...
def doctor_intent_classifier_prompt_manager(
    ...
    refresh_timeout: Optional[float] = None,
    refresh_interval: Optional[float] = None,
) -> prompts._DoctorIntentClassifierV1PromptManager:
...
def patient_history_summarizer_prompt_manager(
    ...
    refresh_timeout: Optional[float] = None,
    refresh_interval: Optional[float] = None,
) -> prompts._PatientHistorySummarizerV1PromptManager:
...
def soap_generator_prompt_manager(
    ...
    refresh_timeout: Optional[float] = None,
    refresh_interval: Optional[float] = None,
) -> prompts._SoapGeneratorV1PromptManager:
...
def visit_summary_writer_prompt_manager(
    ...
    refresh_timeout: Optional[float] = None,
    refresh_interval: Optional[float] = None,
) -> prompts._VisitSummaryWriterV1PromptManager:
